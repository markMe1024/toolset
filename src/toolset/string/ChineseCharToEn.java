...
public class ChineseCharToEn {
    ...
    private final static String[] lc_FirstLetter = { "a", "b", "c", "d", "e", "f", "g", "h", "j", "k", "l", "m", 
    ...
    public static void main(String[] args) {
        ChineseCharToEn chineseCharToEn = getInstance();
        System.out.println(chineseCharToEn.getAllFirstLetter("中"));
    }
